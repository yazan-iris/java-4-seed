...
public class B043Test {
	...
	public void fromString() throws Exception {
		...
		ControlBlockette b = B043.Builder.newInstance().fromBytes(new String(text).getBytes()).build();
		assertEquals(expected, b.toSeedString());

		B043 fromExpected = (B043) B043.Builder.newInstance().fromBytes(expected.getBytes()).build();
