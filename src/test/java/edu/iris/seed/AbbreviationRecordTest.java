...
public class AbbreviationRecordTest {
	...
	public void getAll() throws Exception {
		...
		r.add((AbbreviationBlockette) SeedBlockette.controlBlocketteBuilder(31)
		...
		r.add((AbbreviationBlockette) SeedBlockette.controlBlocketteBuilder(31)
				...
				.build());
		r.add((AbbreviationBlockette) SeedBlockette.controlBlocketteBuilder(31).fromString("03100390185SINSTALL NEW INSTRUMENTS~000")
				.build());
