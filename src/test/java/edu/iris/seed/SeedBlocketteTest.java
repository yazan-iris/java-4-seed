...
public class SeedBlocketteTest {
	...
	public void b053() throws Exception {
		...
		Blockette b = SeedBlockette.Builder.newInstance().build(53, seedString.getBytes());
	...
	public void b054() throws Exception {
		...
		Blockette b = SeedBlockette.Builder.newInstance().build(54, seedString.getBytes());
	...
	public void relaxNonAscii() throws Exception {
		...
		Blockette b = SeedBlockette.Builder.newInstance().build(50, seedString.getBytes());
