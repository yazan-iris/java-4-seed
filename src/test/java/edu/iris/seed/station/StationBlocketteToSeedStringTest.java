...
public class StationBlocketteToSeedStringTest {
	...
	public void b005() throws Exception {
		...
		Blockette b = B005.Builder.newInstance().fromBytes(oldString.getBytes()).build();
	...
	public void b010() throws Exception {
		...
		Blockette b = B010.Builder.newInstance().fromBytes(oldString.getBytes()).build();
		String newString = b.toSeedString();
		assertEquals(oldString, newString);
	}
	...
	public void b011() throws Exception {
		...
		Blockette b = B011.Builder.newInstance().fromBytes(oldString.getBytes()).build();
		String newString = b.toSeedString();
		assertEquals(oldString, newString);
	}
	...
	public void b050() throws Exception {
		...
		Blockette b = B050.Builder.newInstance().fromBytes(oldString.getBytes()).build();
		String newString = b.toSeedString();
		assertEquals(oldString, newString);
	}
	...
	public void b051() throws Exception {
		...
		Blockette b = B051.Builder.newInstance().fromBytes(oldString.getBytes()).build();
		String newString = b.toSeedString();
		assertEquals(oldString, newString);

		oldString = "05100632012,275,06:52:37.0000~2014,317,00:00:00.0000~0001000000";
		b = B051.Builder.newInstance().fromBytes(oldString.getBytes()).build();
	...
	public void b052() throws Exception {
		...
		Blockette b = B052.Builder.newInstance().fromBytes(oldString.getBytes()).build();
		String newString = b.toSeedString();
		assertEquals(oldString, newString);
	}
	...
	public void b053() throws Exception {
		...
		Blockette b = B053.Builder.newInstance().fromBytes(oldString.getBytes()).build();
		String newString = b.toSeedString();
		assertEquals(oldString, newString);
	}
	...
	public void b059() throws Exception {
		...
		Blockette b = B059.Builder.newInstance().fromBytes(oldString.getBytes()).build();
		String newString = b.toSeedString();
		assertEquals(oldString, newString);
