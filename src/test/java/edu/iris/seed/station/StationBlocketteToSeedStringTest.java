...
public class StationBlocketteToSeedStringTest {
	...
	public void b011() throws Exception {
		...
		B011 b = B011.Builder.newInstance().fromBytes(oldString.getBytes()).build();
		String newString = b.toSeedString();
		assertEquals(oldString, newString);
	}
	...
	public void b051() throws Exception {
		...
		B051 b = B051.Builder.newInstance().fromBytes(oldString.getBytes()).build();
		String newString = b.toSeedString();
		assertEquals(oldString, newString);
	...
	public void b052() throws Exception {
		...
		B052 b = B052.Builder.newInstance().fromBytes(oldString.getBytes()).build();
		String newString = b.toSeedString();
		assertEquals(oldString, newString);
	}
	...
	public void b053() throws Exception {
		...
		B053 b = B053.Builder.newInstance().fromBytes(oldString.getBytes()).build();
		String newString = b.toSeedString();
		assertEquals(oldString, newString);
	}
