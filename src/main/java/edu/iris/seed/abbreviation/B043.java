...
public class B043 extends AbstractAbbreviationBlockette implements AbbreviationBlockette,ResponseDictionaryBlockette {
	...
	public static B043 build(byte[] bytes) throws SeedException {
		int offset = 7;
		B043 b = new B043();
