...
public class B042 extends AbstractAbbreviationBlockette<B042> implements AbbreviationBlockette, ResponseDictionaryBlockette {
	...
	private List<edu.iris.seed.station.Number> coefficients = new ArrayList<>();
	...
	public BlocketteBuilder<B042> builder() {
		return new Builder();
	}

	public static class Builder extends BlocketteBuilder<B042> {
