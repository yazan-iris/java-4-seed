...
public class B047 extends AbstractAbbreviationBlockette implements AbbreviationBlockette, ResponseDictionaryBlockette {
	...
	public static B047 build(byte[] bytes) throws SeedException {
		int offset = 7;
		B047 b = new B047();
