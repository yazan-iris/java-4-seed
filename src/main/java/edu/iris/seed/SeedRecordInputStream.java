...
import edu.iris.seed.record.RecordFactory;

public class SeedRecordInputStream extends BufferedInputStream {
	...
	public SeedRecordInputStream(InputStream in) {
		this(in, 1024);
	}

	public SeedRecordInputStream(InputStream in, int size) {
		super(in, size);
	}

	public Record<? extends Blockette> next() throws IOException, SeedException {
